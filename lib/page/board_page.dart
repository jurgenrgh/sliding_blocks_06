...
class _BoardPageState extends State<BoardPage> {
  ...
  Widget build(BuildContext context) {
    ...
    double tilePixWidth = (Globals.screenWidth - 2 * Globals.boardMargin) / boardNbrTilesWidth;
    double boardPixWidth = tilePixWidth * boardNbrTilesWidth + 2 * Globals.boardMargin;
    double boardPixHeight = tilePixWidth * boardNbrTilesHeight + 2 * Globals.boardMargin;
          ...
          children: [
            ...
            Row(
              ...
              children: <Widget>[
                IconButton(
                  ...
                  onPressed: () => {
                    setState(() => {Globals.showNumbers = !Globals.showNumbers}),
                  },
                ),
                IconButton(
                  iconSize: 36,
            ...
            if (showGoal)
              Container(
                ...
                decoration: BoxDecoration(
                  color: Colors.blue[800],
                  border: Border.all(color: Colors.blue[800]!, width: Globals.smallBoardMargin),
                ),
                child: Stack(
